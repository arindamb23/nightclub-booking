...
title AI Hunters ComfyFlow v1.0.2 - Start
cd /d "%~dp0"
set "ROOT=%~dp0"
...
echo.
echo  AI Hunters ComfyFlow v1.0.2
echo  ----------------------------------------------
...
start "ComfyFlow-ComfyUI" /min cmd /k ""!COMFY_PY!" "!COMFY_DIR!\main.py" --listen %COMFYUI_HOST% --port %COMFYUI_PORT% %COMFYUI_EXTRA_ARGS%"
