...
class WanVideoUniAnimatePoseInput(Node[WanVideoUniAnimatePoseInputInputs, WanVideoUniAnimatePoseInputOutputs]):
    ...
    def __init__(self, pose_images: Union[Slot[Image], Image], strength: float = 1.0, start_percent: float = 0.0, end_percent: float = 1.0, reference_pose_image: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"pose_images": pose_images, "strength": strength, "start_percent": start_percent, "end_percent": end_percent, "reference_pose_image": reference_pose_image})
