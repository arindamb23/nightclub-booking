...
Transforms image based on the normalized amplitude.
    ...
    def __init__(self, normalized_amp: Union[Slot[Any], Any], image: Union[Slot[Image], Image], zoom_scale: float = 0.0, x_offset: int = 0, y_offset: int = 0, cumulative: bool = False):
