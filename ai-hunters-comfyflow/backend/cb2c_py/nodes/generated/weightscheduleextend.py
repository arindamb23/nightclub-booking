...
Extends, and converts if needed, different value lists/series  
    ...
    Inputs:
        ...
        - output_type (Union[Literal['match_input', 'list', 'pandas series', 'tensor', str) (default: 'match_input')
    ...
    def __init__(self, input_values_1: float = 0.0, input_values_2: float = 0.0, output_type: Union[Union[Literal['match_input', 'list', 'pandas series', 'tensor'], str], str] = 'match_input'):
