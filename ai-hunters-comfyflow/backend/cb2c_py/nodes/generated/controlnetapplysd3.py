...
class ControlNetApplySD3(Node[ControlNetApplySD3Inputs, ControlNetApplySD3Outputs]):
    ...
    def __init__(self, positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], control_net: Union[Slot[Any], Any], vae: Union[Slot[Vae], Vae], image: Union[Slot[Image], Image], strength: float = 1.0, start_percent: float = 0.0, end_percent: float = 1.0):
