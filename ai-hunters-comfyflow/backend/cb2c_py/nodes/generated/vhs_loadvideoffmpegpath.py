...
class VHS_LoadVideoFFmpegPath(Node[VHS_LoadVideoFFmpegPathInputs, VHS_LoadVideoFFmpegPathOutputs]):
    ...
    def __init__(self, video: str, force_rate: Union[float, int] = 0, custom_width: int = 0, custom_height: int = 0, frame_load_cap: int = 0, start_time: Union[float, int] = 0, meta_batch: Optional[Union[Slot[Any], Any]] = None, vae: Optional[Union[Slot[Vae], Vae]] = None, format: Union[Union[Literal['None', 'AnimateDiff', 'Mochi', 'LTXV', 'Hunyuan', 'Cosmos', 'Wan'], str], str] = 'AnimateDiff'):
        super().__init__(**{"video": video, "force_rate": force_rate, "custom_width": custom_width, "custom_height": custom_height, "frame_load_cap": frame_load_cap, "start_time": start_time, "meta_batch": meta_batch, "vae": vae, "format": format})
