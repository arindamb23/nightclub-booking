...
class KlingStartEndFrameNodeInputs(InputSlots):
    ...
    mode: Slot[Union[Union[Literal['standard mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1-5', 'pro mode / 10s duration / kling-v1-5', 'pro mode / 5s duration / kling-v1-6', 'pro mode / 10s duration / kling-v1-6'], str], str]]
    def __init__(self, node: "Node"):
        ...
        self.mode = Slot[Union[Union[Literal['standard mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1-5', 'pro mode / 10s duration / kling-v1-5', 'pro mode / 5s duration / kling-v1-6', 'pro mode / 10s duration / kling-v1-6'], str], str]](node, "mode", ['standard mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1-5', 'pro mode / 10s duration / kling-v1-5', 'pro mode / 5s duration / kling-v1-6', 'pro mode / 10s duration / kling-v1-6'])
...
class KlingStartEndFrameNode(Node[KlingStartEndFrameNodeInputs, KlingStartEndFrameNodeOutputs]):
    ...
    Inputs:
        ...
        - mode (Union[Literal['standard mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1-5', 'pro mode / 10s duration / kling-v1-5', 'pro mode / 5s duration / kling-v1-6', 'pro mode / 10s duration / kling-v1-6', str) (default: 'pro mode / 5s duration / kling-v1-5')
    ...
    def __init__(self, start_frame: Union[Slot[Image], Image] = None, end_frame: Union[Slot[Image], Image] = None, prompt: str = None, negative_prompt: str = None, cfg_scale: float = 0.5, aspect_ratio: str = '16:9', mode: Union[Union[Literal['standard mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1', 'pro mode / 5s duration / kling-v1-5', 'pro mode / 10s duration / kling-v1-5', 'pro mode / 5s duration / kling-v1-6', 'pro mode / 10s duration / kling-v1-6'], str], str] = 'pro mode / 5s duration / kling-v1-5'):
