...
class SamplerLCMUpscaleInputs(InputSlots):
    ...
    upscale_method: Slot[Union[Literal['bislerp', 'nearest-exact', 'bilinear', 'area', 'bicubic'], str]]
    def __init__(self, node: "Node"):
        self.scale_ratio = Slot[float](node, "scale_ratio", 'FLOAT')
        self.scale_steps = Slot[int](node, "scale_steps", 'INT')
        self.upscale_method = Slot[Union[Literal['bislerp', 'nearest-exact', 'bilinear', 'area', 'bicubic'], str]](node, "upscale_method", ['bislerp', 'nearest-exact', 'bilinear', 'area', 'bicubic'])
...
class SamplerLCMUpscale(Node[SamplerLCMUpscaleInputs, SamplerLCMUpscaleOutputs]):
    ...
    Inputs:
        ...
        - upscale_method (Union[Literal['bislerp', 'nearest-exact', 'bilinear', 'area', 'bicubic', str)
    ...
    def __init__(self, upscale_method: Union[Literal['bislerp', 'nearest-exact', 'bilinear', 'area', 'bicubic'], str], scale_ratio: float = 1.0, scale_steps: int = -1):
