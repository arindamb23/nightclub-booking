...
class InpaintModelConditioning(Node[InpaintModelConditioningInputs, InpaintModelConditioningOutputs]):
    ...
    def __init__(self, positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], vae: Union[Slot[Vae], Vae], pixels: Union[Slot[Image], Image], mask: Union[Slot[Image], Image], noise_mask: bool = True):
