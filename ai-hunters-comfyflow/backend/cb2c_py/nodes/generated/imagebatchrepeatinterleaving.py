...
with repeats 2 becomes batch of 10 images: 0, 0, 1, 1, 2, 2, 3, 3, 4, 4  
    ...
    def __init__(self, images: Union[Slot[Image], Image], repeats: int = 1, mask: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"images": images, "repeats": repeats, "mask": mask})
