...
class SeparateMasksInputs(InputSlots):
    ...
    mode: Slot[Union[Literal['convex_polygons', 'area', 'box'], str]]
    ...
    def __init__(self, node: "Node"):
        ...
        self.mode = Slot[Union[Literal['convex_polygons', 'area', 'box'], str]](node, "mode", ['convex_polygons', 'area', 'box'])
...
class SeparateMasks(Node[SeparateMasksInputs, SeparateMasksOutputs]):
    ...
    Inputs:
        ...
        - mode (Union[Literal['convex_polygons', 'area', 'box', str)
    ...
    def __init__(self, mask: Union[Slot[Image], Image], mode: Union[Literal['convex_polygons', 'area', 'box'], str], size_threshold_width: int = 256, size_threshold_height: int = 256, max_poly_points: int = 8):
