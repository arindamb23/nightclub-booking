...
class ImageBatchTestPattern(Node[ImageBatchTestPatternInputs, ImageBatchTestPatternOutputs]):
    ...
    def __init__(self, font: Union[Literal['FreeMono.ttf', 'FreeMonoBoldOblique.otf', 'TTNorms-Black.otf'], str], batch_size: int = 1, start_from: int = 0, text_x: int = 256, text_y: int = 256, width: int = 512, height: int = 512, font_size: int = 255):
