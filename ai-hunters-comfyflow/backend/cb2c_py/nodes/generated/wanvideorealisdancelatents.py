...
class WanVideoRealisDanceLatentsInputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.hamer_latent = Slot[Latent](node, "hamer_latent", 'LATENT')
...
class WanVideoRealisDanceLatents(Node[WanVideoRealisDanceLatentsInputs, WanVideoRealisDanceLatentsOutputs]):
    ...
    def __init__(self, ref_latent: Union[Slot[Latent], Latent], smpl_latent: Union[Slot[Latent], Latent], pose_cond_start_percent: float = 0.0, pose_cond_end_percent: float = 1.0, hamer_latent: Optional[Union[Slot[Latent], Latent]] = None):
        super().__init__(**{"ref_latent": ref_latent, "smpl_latent": smpl_latent, "pose_cond_start_percent": pose_cond_start_percent, "pose_cond_end_percent": pose_cond_end_percent, "hamer_latent": hamer_latent})
