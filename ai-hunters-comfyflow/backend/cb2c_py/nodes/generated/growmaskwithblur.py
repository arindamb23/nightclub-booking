...
- fill_holes: fill holes in the mask (slow)
    ...
    def __init__(self, mask: Union[Slot[Image], Image], expand: int = 0, incremental_expandrate: float = 0.0, tapered_corners: bool = True, flip_input: bool = False, blur_radius: float = 0.0, lerp_alpha: float = 1.0, decay_factor: float = 1.0, fill_holes: bool = False):
        super().__init__(**{"mask": mask, "expand": expand, "incremental_expandrate": incremental_expandrate, "tapered_corners": tapered_corners, "flip_input": flip_input, "blur_radius": blur_radius, "lerp_alpha": lerp_alpha, "decay_factor": decay_factor, "fill_holes": fill_holes})
