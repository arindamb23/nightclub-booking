...
class CosmosPredict2ImageToVideoLatent(Node[CosmosPredict2ImageToVideoLatentInputs, CosmosPredict2ImageToVideoLatentOutputs]):
    ...
    def __init__(self, vae: Union[Slot[Vae], Vae], width: int = 848, height: int = 480, length: int = 93, batch_size: int = 1, start_image: Optional[Union[Slot[Image], Image]] = None, end_image: Optional[Union[Slot[Image], Image]] = None):
