...
class VHS_VideoCombineInputs(InputSlots):
    ...
    format: Slot[Union[Literal['image/gif', 'image/webp', 'video/ffmpeg-gif', 'video/8bit-png', 'video/nvenc_av1-mp4', 'video/webm', 'video/h265-mp4', 'video/ProRes', 'video/h264-mp4', 'video/nvenc_hevc-mp4', 'video/av1-webm', 'video/16bit-png', 'video/nvenc_h264-mp4'], str]]
    pingpong: Slot[bool]
    ...
    def __init__(self, node: "Node"):
        ...
        self.format = Slot[Union[Literal['image/gif', 'image/webp', 'video/ffmpeg-gif', 'video/8bit-png', 'video/nvenc_av1-mp4', 'video/webm', 'video/h265-mp4', 'video/ProRes', 'video/h264-mp4', 'video/nvenc_hevc-mp4', 'video/av1-webm', 'video/16bit-png', 'video/nvenc_h264-mp4'], str]](node, "format", ['image/gif', 'image/webp', 'video/ffmpeg-gif', 'video/8bit-png', 'video/nvenc_av1-mp4', 'video/webm', 'video/h265-mp4', 'video/ProRes', 'video/h264-mp4', 'video/nvenc_hevc-mp4', 'video/av1-webm', 'video/16bit-png', 'video/nvenc_h264-mp4'])
...
class VHS_VideoCombine(Node[VHS_VideoCombineInputs, VHS_VideoCombineOutputs]):
    ...
    Inputs:
        ...
        - format (Union[Literal['image/gif', 'image/webp', 'video/ffmpeg-gif', 'video/8bit-png', 'video/nvenc_av1-mp4', 'video/webm', 'video/h265-mp4', 'video/ProRes', 'video/h264-mp4', 'video/nvenc_hevc-mp4', 'video/av1-webm', 'video/16bit-png', 'video/nvenc_h264-mp4', str)
    ...
    def __init__(self, images: Union[Slot[Image], Image], format: Union[Literal['image/gif', 'image/webp', 'video/ffmpeg-gif', 'video/8bit-png', 'video/nvenc_av1-mp4', 'video/webm', 'video/h265-mp4', 'video/ProRes', 'video/h264-mp4', 'video/nvenc_hevc-mp4', 'video/av1-webm', 'video/16bit-png', 'video/nvenc_h264-mp4'], str], frame_rate: Union[float, int] = 8, loop_count: int = 0, filename_prefix: str = 'AnimateDiff', pingpong: bool = False, save_output: bool = True, audio: Optional[Union[Slot[Any], Any]] = None, meta_batch: Optional[Union[Slot[Any], Any]] = None, vae: Optional[Union[Slot[Vae], Vae]] = None):
        super().__init__(**{"images": images, "frame_rate": frame_rate, "loop_count": loop_count, "filename_prefix": filename_prefix, "format": format, "pingpong": pingpong, "save_output": save_output, "audio": audio, "meta_batch": meta_batch, "vae": vae})
