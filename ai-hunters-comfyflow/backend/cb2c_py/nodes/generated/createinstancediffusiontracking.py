...
class CreateInstanceDiffusionTrackingInputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.fit_in_frame = Slot[bool](node, "fit_in_frame", 'BOOLEAN')
...
"1.head": "((head))",  
    ...
    Inputs:
        ...
        - fit_in_frame (bool) (default: True)
    ...
    def __init__(self, coordinates: str, width: int = 512, height: int = 512, bbox_width: int = 512, bbox_height: int = 512, class_name: str = 'class_name', class_id: int = 0, prompt: str = 'prompt', size_multiplier: float = [1.0], fit_in_frame: bool = True):
        super().__init__(**{"coordinates": coordinates, "width": width, "height": height, "bbox_width": bbox_width, "bbox_height": bbox_height, "class_name": class_name, "class_id": class_id, "prompt": prompt, "size_multiplier": size_multiplier, "fit_in_frame": fit_in_frame})
