...
class WanVideoTeaCacheKJInputs(InputSlots):
    ...
    cache_device: Slot[Union[Union[Literal['main_device', 'offload_device'], str], str]]
    coefficients: Slot[Union[Union[Literal['disabled', '1.3B', '14B', 'i2v_480', 'i2v_720'], str], str]]
    def __init__(self, node: "Node"):
        ...
        self.cache_device = Slot[Union[Union[Literal['main_device', 'offload_device'], str], str]](node, "cache_device", ['main_device', 'offload_device'])
        self.coefficients = Slot[Union[Union[Literal['disabled', '1.3B', '14B', 'i2v_480', 'i2v_720'], str], str]](node, "coefficients", ['disabled', '1.3B', '14B', 'i2v_480', 'i2v_720'])
...
+-------------------+--------+---------+--------+
    ...
    Inputs:
        ...
        - cache_device (Union[Literal['main_device', 'offload_device', str) (default: 'offload_device')
          Device to cache to
        - coefficients (Union[Literal['disabled', '1.3B', '14B', 'i2v_480', 'i2v_720', str) (default: 'i2v_480')
    ...
    def __init__(self, model: Union[Slot[Model], Model], rel_l1_thresh: float = 0.275, start_percent: float = 0.1, end_percent: float = 1.0, cache_device: Union[Union[Literal['main_device', 'offload_device'], str], str] = 'offload_device', coefficients: Union[Union[Literal['disabled', '1.3B', '14B', 'i2v_480', 'i2v_720'], str], str] = 'i2v_480'):
