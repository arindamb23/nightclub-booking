...
class FluxProFillNode(Node[FluxProFillNodeInputs, FluxProFillNodeOutputs]):
    ...
    def __init__(self, image: Union[Slot[Image], Image], mask: Union[Slot[Image], Image], prompt: str = '', prompt_upsampling: bool = False, guidance: Union[float, int] = 60, steps: int = 50, seed: int = 0):
