...
class DownloadAndLoadCLIPSegInputs(InputSlots):
    model: Slot[Union[Literal['Kijai/clipseg-rd64-refined-fp16', 'CIDAS/clipseg-rd64-refined'], str]]
    def __init__(self, node: "Node"):
        self.model = Slot[Union[Literal['Kijai/clipseg-rd64-refined-fp16', 'CIDAS/clipseg-rd64-refined'], str]](node, "model", ['Kijai/clipseg-rd64-refined-fp16', 'CIDAS/clipseg-rd64-refined'])
...
to ComfyUI/models/clip_seg
    ...
    Inputs:
        - model (Union[Literal['Kijai/clipseg-rd64-refined-fp16', 'CIDAS/clipseg-rd64-refined', str)
    ...
    def __init__(self, model: Union[Literal['Kijai/clipseg-rd64-refined-fp16', 'CIDAS/clipseg-rd64-refined'], str]):
