...
class VHS_LoadImagePath(Node[VHS_LoadImagePathInputs, VHS_LoadImagePathOutputs]):
    ...
    def __init__(self, image: str, custom_width: int = 0, custom_height: int = 0, vae: Optional[Union[Slot[Vae], Vae]] = None):
        super().__init__(**{"image": image, "custom_width": custom_width, "custom_height": custom_height, "vae": vae})
