...
class ImageCropByMaskAndResize(Node[ImageCropByMaskAndResizeInputs, ImageCropByMaskAndResizeOutputs]):
    ...
    def __init__(self, image: Union[Slot[Image], Image], mask: Union[Slot[Image], Image], base_resolution: int = 512, padding: int = 0, min_crop_resolution: int = 128, max_crop_resolution: int = 512):
