...
class InjectLatentNoise_Inputs(InputSlots):
    ...
    normalize: Slot[Union[Union[Literal['false', 'true'], str], str]]
    mask: Slot[Image]
    def __init__(self, node: "Node"):
        ...
        self.normalize = Slot[Union[Union[Literal['false', 'true'], str], str]](node, "normalize", ['false', 'true'])
...
class InjectLatentNoise_(Node[InjectLatentNoise_Inputs, InjectLatentNoise_Outputs]):
    ...
    Inputs:
        ...
        - normalize (Union[Literal['false', 'true', str) (default: 'false')
        - mask (Image)
    ...
    def __init__(self, latent: Union[Slot[Latent], Latent], noise_seed: int = 0, noise_strength: float = 1.0, normalize: Union[Union[Literal['false', 'true'], str], str] = 'false', mask: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"latent": latent, "noise_seed": noise_seed, "noise_strength": noise_strength, "normalize": normalize, "mask": mask})
