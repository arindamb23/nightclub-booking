...
class LTXVImgToVideo(Node[LTXVImgToVideoInputs, LTXVImgToVideoOutputs]):
    ...
    def __init__(self, positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], vae: Union[Slot[Vae], Vae], image: Union[Slot[Image], Image], width: int = 768, height: int = 512, length: int = 97, batch_size: int = 1, strength: float = 1.0):
