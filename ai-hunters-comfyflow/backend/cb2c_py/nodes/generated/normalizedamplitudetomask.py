...
class NormalizedAmplitudeToMaskInputs(InputSlots):
    ...
    location_y: Slot[int]
    size: Slot[int]
    shape: Slot[Union[Union[Literal['none', 'circle', 'square', 'triangle'], str], str]]
    color: Slot[Union[Union[Literal['white', 'amplitude'], str], str]]
    def __init__(self, node: "Node"):
        ...
        self.shape = Slot[Union[Union[Literal['none', 'circle', 'square', 'triangle'], str], str]](node, "shape", ['none', 'circle', 'square', 'triangle'])
        self.color = Slot[Union[Union[Literal['white', 'amplitude'], str], str]](node, "color", ['white', 'amplitude'])
...
Creates masks based on the normalized amplitude.
    ...
    Inputs:
        ...
        - shape (Union[Literal['none', 'circle', 'square', 'triangle', str) (default: 'none')
        - color (Union[Literal['white', 'amplitude', str) (default: 'amplitude')
    ...
    def __init__(self, normalized_amp: Union[Slot[Any], Any], width: int = 512, height: int = 512, frame_offset: int = 0, location_x: int = 256, location_y: int = 256, size: int = 128, shape: Union[Union[Literal['none', 'circle', 'square', 'triangle'], str], str] = 'none', color: Union[Union[Literal['white', 'amplitude'], str], str] = 'amplitude'):
