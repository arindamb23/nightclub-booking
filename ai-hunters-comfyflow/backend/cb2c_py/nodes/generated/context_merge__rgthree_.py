...
# Define input and output slot classes for Context_Merge__rgthree_
class Context_Merge__rgthree_Inputs(InputSlots):

    def __init__(self, node: "Node"):
        pass

class Context_Merge__rgthree_Outputs(OutputSlots):
    context: Slot[Any]
    model: Slot[Model]
    clip: Slot[Clip]
    vae: Slot[Vae]
...
class Context_Merge__rgthree_(Node[Context_Merge__rgthree_Inputs, Context_Merge__rgthree_Outputs]):
    ...
    def __init__(self, ):
        super().__init__(**{})
        self.inputs = Context_Merge__rgthree_Inputs(self)
        self.outputs = Context_Merge__rgthree_Outputs(self)
