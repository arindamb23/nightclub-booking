...
class HunyuanVideoEncodeKeyframesToCond(Node[HunyuanVideoEncodeKeyframesToCondInputs, HunyuanVideoEncodeKeyframesToCondOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], positive: Union[Slot[Conditioning], Conditioning], vae: Union[Slot[Vae], Vae], start_frame: Union[Slot[Image], Image], end_frame: Union[Slot[Image], Image], num_frames: int = 33, tile_size: int = 512, overlap: int = 64, temporal_size: int = 64, temporal_overlap: int = 8, negative: Optional[Union[Slot[Conditioning], Conditioning]] = None):
        super().__init__(**{"model": model, "positive": positive, "vae": vae, "start_frame": start_frame, "end_frame": end_frame, "num_frames": num_frames, "tile_size": tile_size, "overlap": overlap, "temporal_size": temporal_size, "temporal_overlap": temporal_overlap, "negative": negative})
