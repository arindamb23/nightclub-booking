...
reports free VRAM before and after the operations.
    ...
    def __init__(self, empty_cache: bool = True, gc_collect: bool = True, unload_all_models: bool = False, any_input: Optional[Union[Slot[Any], Any]] = None, image_pass: Optional[Union[Slot[Image], Image]] = None, model_pass: Optional[Union[Slot[Model], Model]] = None):
        super().__init__(**{"empty_cache": empty_cache, "gc_collect": gc_collect, "unload_all_models": unload_all_models, "any_input": any_input, "image_pass": image_pass, "model_pass": model_pass})
