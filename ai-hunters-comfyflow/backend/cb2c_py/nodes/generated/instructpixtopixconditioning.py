...
class InstructPixToPixConditioning(Node[InstructPixToPixConditioningInputs, InstructPixToPixConditioningOutputs]):
    ...
    def __init__(self, positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], vae: Union[Slot[Vae], Vae], pixels: Union[Slot[Image], Image]):
