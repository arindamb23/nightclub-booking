...
class SamplerCustom(Node[SamplerCustomInputs, SamplerCustomOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], sampler: Union[Slot[Any], Any], sigmas: Union[Slot[Any], Any], latent_image: Union[Slot[Latent], Latent], add_noise: bool = True, noise_seed: int = 0, cfg: float = 8.0):
