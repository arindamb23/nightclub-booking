...
class PointsEditorInputs(InputSlots):
    ...
    bbox_store: Slot[str]
    bboxes: Slot[str]
    bbox_format: Slot[Union[Literal['xyxy', 'xywh'], str]]
    width: Slot[int]
    height: Slot[int]
    normalize: Slot[bool]
    bg_image: Slot[Image]
    def __init__(self, node: "Node"):
        ...
        self.bbox_format = Slot[Union[Literal['xyxy', 'xywh'], str]](node, "bbox_format", ['xyxy', 'xywh'])
...
you can clear the image from the context menu by right clicking on the canvas  
    ...
    Inputs:
        ...
        - bbox_store (str)
        - bboxes (str)
        - bbox_format (Union[Literal['xyxy', 'xywh', str)
    ...
    def __init__(self, points_store: str, coordinates: str, neg_coordinates: str, bbox_store: str, bboxes: str, bbox_format: Union[Literal['xyxy', 'xywh'], str], width: int = 512, height: int = 512, normalize: bool = False, bg_image: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"points_store": points_store, "coordinates": coordinates, "neg_coordinates": neg_coordinates, "bbox_store": bbox_store, "bboxes": bboxes, "bbox_format": bbox_format, "width": width, "height": height, "normalize": normalize, "bg_image": bg_image})
