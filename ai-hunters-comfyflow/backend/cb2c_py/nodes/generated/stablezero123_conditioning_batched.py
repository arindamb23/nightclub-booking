...
class StableZero123_Conditioning_Batched(Node[StableZero123_Conditioning_BatchedInputs, StableZero123_Conditioning_BatchedOutputs]):
    ...
    def __init__(self, clip_vision: Union[Slot[Any], Any], init_image: Union[Slot[Image], Image], vae: Union[Slot[Vae], Vae], width: int = 256, height: int = 256, batch_size: int = 1, elevation: float = 0.0, azimuth: float = 0.0, elevation_batch_increment: float = 0.0, azimuth_batch_increment: float = 0.0):
