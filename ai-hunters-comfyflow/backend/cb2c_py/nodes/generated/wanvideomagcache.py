...
class WanVideoMagCache(Node[WanVideoMagCacheInputs, WanVideoMagCacheOutputs]):
    ...
    def __init__(self, magcache_thresh: float = 0.02, magcache_K: int = 4, start_step: int = 1, end_step: int = -1, cache_device: Union[Union[Literal['main_device', 'offload_device'], str], str] = 'offload_device'):
