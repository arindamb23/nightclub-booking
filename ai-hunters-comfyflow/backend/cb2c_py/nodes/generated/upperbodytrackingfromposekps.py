...
class UpperBodyTrackingFromPoseKps(Node[UpperBodyTrackingFromPoseKpsInputs, UpperBodyTrackingFromPoseKpsOutputs]):
    ...
    def __init__(self, pose_kps: Union[Slot[Any], Any], id_include: str = '', Head_width_height: str = '256, 256', Neck_width_height: str = '100, 100', Shoulder_width_height: str = '', Torso_width_height: str = '350, 450', RArm_width_height: str = '128, 256', RForearm_width_height: str = '128, 256', LArm_width_height: str = '128, 256', LForearm_width_height: str = '128, 256'):
