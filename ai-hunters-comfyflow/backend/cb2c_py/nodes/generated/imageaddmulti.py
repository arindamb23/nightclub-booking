...
class ImageAddMultiInputs(InputSlots):
    ...
    image_1: Slot[Image]
    image_2: Slot[Image]
    blending: Slot[Union[Union[Literal['add', 'subtract', 'multiply', 'difference'], str], str]]
    ...
    def __init__(self, node: "Node"):
        ...
        self.blending = Slot[Union[Union[Literal['add', 'subtract', 'multiply', 'difference'], str], str]](node, "blending", ['add', 'subtract', 'multiply', 'difference'])
...
with the **inputcount** and clicking update.
    ...
    Inputs:
        ...
        - image_1 (Image)
        - image_2 (Image)
        - blending (Union[Literal['add', 'subtract', 'multiply', 'difference', str) (default: 'add')
    ...
    def __init__(self, image_1: Union[Slot[Image], Image], image_2: Union[Slot[Image], Image], inputcount: int = 2, blending: Union[Union[Literal['add', 'subtract', 'multiply', 'difference'], str], str] = 'add', blend_amount: float = 0.5):
