...
class TransparentBGSession_Inputs(InputSlots):
    mode: Slot[Union[Literal['base', 'fast', 'base-nightly'], str]]
    use_jit: Slot[bool]
    def __init__(self, node: "Node"):
        self.mode = Slot[Union[Literal['base', 'fast', 'base-nightly'], str]](node, "mode", ['base', 'fast', 'base-nightly'])
...
class TransparentBGSession_(Node[TransparentBGSession_Inputs, TransparentBGSession_Outputs]):
    ...
    Inputs:
        - mode (Union[Literal['base', 'fast', 'base-nightly', str)
    ...
    def __init__(self, mode: Union[Literal['base', 'fast', 'base-nightly'], str], use_jit: bool = True):
