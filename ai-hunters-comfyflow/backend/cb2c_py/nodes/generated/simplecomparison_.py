...
class SimpleComparison_Inputs(InputSlots):
    a: Slot[Any]
    b: Slot[Any]
    comparison: Slot[Union[Literal['==', '!=', '<', '<=', '>', '>='], str]]
    def __init__(self, node: "Node"):
        self.a = Slot[Any](node, "a", '*')
        self.b = Slot[Any](node, "b", '*')
        self.comparison = Slot[Union[Literal['==', '!=', '<', '<=', '>', '>='], str]](node, "comparison", ['==', '!=', '<', '<=', '>', '>='])
...
class SimpleComparison_(Node[SimpleComparison_Inputs, SimpleComparison_Outputs]):
    ...
    def __init__(self, comparison: Union[Literal['==', '!=', '<', '<=', '>', '>='], str], a: Union[Slot[Any], Any] = 0, b: Union[Slot[Any], Any] = 0):
