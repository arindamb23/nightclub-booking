...
Grow value is the amount to grow the shape on each frame, creating animated masks.
    ...
    def __init__(self, shape: Union[Union[Literal['circle', 'square', 'triangle'], str], str] = 'circle', frames: int = 1, location_x: int = 256, location_y: int = 256, grow: int = 0, frame_width: int = 512, frame_height: int = 512, shape_width: int = 128, shape_height: int = 128):
