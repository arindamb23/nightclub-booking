...
class InsertImagesToBatchIndexedInputs(InputSlots):
    ...
    indexes: Slot[str]
    mode: Slot[Union[Literal['replace', 'insert'], str]]
    def __init__(self, node: "Node"):
        ...
        self.mode = Slot[Union[Literal['replace', 'insert'], str]](node, "mode", ['replace', 'insert'])
...
Inserts images at the specified indices into the original image batch.
    ...
    Inputs:
        ...
        - mode (Union[Literal['replace', 'insert', str)
    ...
    def __init__(self, original_images: Union[Slot[Image], Image], images_to_insert: Union[Slot[Image], Image], indexes: str = '0, 1, 2', mode: Optional[Union[Literal['replace', 'insert'], str]] = None):
        super().__init__(**{"original_images": original_images, "images_to_insert": images_to_insert, "indexes": indexes, "mode": mode})
