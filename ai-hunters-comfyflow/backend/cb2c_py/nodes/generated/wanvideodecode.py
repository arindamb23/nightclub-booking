...
class WanVideoDecodeInputs(InputSlots):
    ...
    normalization: Slot[Union[Literal['default', 'minmax'], str]]
    def __init__(self, node: "Node"):
        ...
        self.normalization = Slot[Union[Literal['default', 'minmax'], str]](node, "normalization", ['default', 'minmax'])
...
class WanVideoDecode(Node[WanVideoDecodeInputs, WanVideoDecodeOutputs]):
    ...
    Inputs:
        ...
        - normalization (Union[Literal['default', 'minmax', str)
    ...
    def __init__(self, vae: Union[Slot[Any], Any], samples: Union[Slot[Latent], Latent], enable_vae_tiling: bool = False, tile_x: int = 272, tile_y: int = 272, tile_stride_x: int = 144, tile_stride_y: int = 128, normalization: Optional[Union[Literal['default', 'minmax'], str]] = None):
        super().__init__(**{"vae": vae, "samples": samples, "enable_vae_tiling": enable_vae_tiling, "tile_x": tile_x, "tile_y": tile_y, "tile_stride_x": tile_stride_x, "tile_stride_y": tile_stride_y, "normalization": normalization})
