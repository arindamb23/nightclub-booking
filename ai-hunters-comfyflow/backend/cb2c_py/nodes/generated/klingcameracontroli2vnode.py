...
class KlingCameraControlI2VNode(Node[KlingCameraControlI2VNodeInputs, KlingCameraControlI2VNodeOutputs]):
    ...
    def __init__(self, camera_control: Union[Slot[Any], Any], start_frame: Union[Slot[Image], Image] = None, prompt: str = None, negative_prompt: str = None, cfg_scale: float = 0.75, aspect_ratio: str = '16:9'):
