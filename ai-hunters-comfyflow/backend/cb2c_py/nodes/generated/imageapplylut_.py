...
class ImageApplyLUT_Inputs(InputSlots):
    image: Slot[Image]
    lut_file: Slot[Union[Literal['put_luts_files_here.txt'], str]]
    gamma_correction: Slot[bool]
    clip_values: Slot[bool]
    strength: Slot[float]
    def __init__(self, node: "Node"):
        self.image = Slot[Image](node, "image", 'IMAGE')
        self.lut_file = Slot[Union[Literal['put_luts_files_here.txt'], str]](node, "lut_file", ['put_luts_files_here.txt'])
...
class ImageApplyLUT_(Node[ImageApplyLUT_Inputs, ImageApplyLUT_Outputs]):
    ...
    Inputs:
        - image (Image)
        - lut_file (Union[Literal['put_luts_files_here.txt', str)
    ...
    def __init__(self, image: Union[Slot[Image], Image], lut_file: Union[Literal['put_luts_files_here.txt'], str], gamma_correction: bool = True, clip_values: bool = True, strength: float = 1.0):
