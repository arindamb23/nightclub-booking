...
class CLIPVisionEncodeInputs(InputSlots):
    ...
    image: Slot[Image]
    crop: Slot[Union[Literal['center', 'none'], str]]
    def __init__(self, node: "Node"):
        self.clip_vision = Slot[Any](node, "clip_vision", 'CLIP_VISION')
        self.image = Slot[Image](node, "image", 'IMAGE')
        self.crop = Slot[Union[Literal['center', 'none'], str]](node, "crop", ['center', 'none'])
...
class CLIPVisionEncode(Node[CLIPVisionEncodeInputs, CLIPVisionEncodeOutputs]):
    ...
    Inputs:
        - clip_vision (Any)
        - image (Image)
        - crop (Union[Literal['center', 'none', str)
    ...
    def __init__(self, clip_vision: Union[Slot[Any], Any], image: Union[Slot[Image], Image], crop: Union[Literal['center', 'none'], str]):
