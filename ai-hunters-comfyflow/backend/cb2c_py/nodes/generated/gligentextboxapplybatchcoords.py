...
bounding boxes.
    ...
    def __init__(self, conditioning_to: Union[Slot[Conditioning], Conditioning], latents: Union[Slot[Latent], Latent], clip: Union[Slot[Clip], Clip], gligen_textbox_model: Union[Slot[Any], Any], coordinates: str, text: str, width: int = 128, height: int = 128, size_multiplier: float = [1.0]):
        super().__init__(**{"conditioning_to": conditioning_to, "latents": latents, "clip": clip, "gligen_textbox_model": gligen_textbox_model, "coordinates": coordinates, "text": text, "width": width, "height": height, "size_multiplier": size_multiplier})
