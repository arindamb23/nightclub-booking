...
class ScheduledCFGGuidance(Node[ScheduledCFGGuidanceInputs, ScheduledCFGGuidanceOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], cfg: float = 6.0, start_percent: float = 0.0, end_percent: float = 1.0):
