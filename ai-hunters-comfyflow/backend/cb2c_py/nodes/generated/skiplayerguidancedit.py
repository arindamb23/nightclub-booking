...
class SkipLayerGuidanceDiT(Node[SkipLayerGuidanceDiTInputs, SkipLayerGuidanceDiTOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], double_layers: str = '7, 8, 9', single_layers: str = '7, 8, 9', scale: float = 3.0, start_percent: float = 0.01, end_percent: float = 0.15, rescaling_scale: float = 0.0):
