...
class DualCFGGuider(Node[DualCFGGuiderInputs, DualCFGGuiderOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], cond1: Union[Slot[Conditioning], Conditioning], cond2: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], cfg_conds: float = 8.0, cfg_cond2_negative: float = 8.0):
