...
class WanVideoFlowEditInputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.source_image_embeds = Slot[Any](node, "source_image_embeds", 'WANVIDIMAGE_EMBEDS')
...
class WanVideoFlowEdit(Node[WanVideoFlowEditInputs, WanVideoFlowEditOutputs]):
    ...
    def __init__(self, source_embeds: Union[Slot[Any], Any], skip_steps: int = 4, drift_steps: int = 0, drift_flow_shift: float = 3.0, source_cfg: float = 6.0, drift_cfg: float = 6.0, source_image_embeds: Optional[Union[Slot[Any], Any]] = None):
        super().__init__(**{"source_embeds": source_embeds, "skip_steps": skip_steps, "drift_steps": drift_steps, "drift_flow_shift": drift_flow_shift, "source_cfg": source_cfg, "drift_cfg": drift_cfg, "source_image_embeds": source_image_embeds})
