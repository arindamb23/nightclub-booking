...
class GLIGENTextBoxApply(Node[GLIGENTextBoxApplyInputs, GLIGENTextBoxApplyOutputs]):
    ...
    def __init__(self, conditioning_to: Union[Slot[Conditioning], Conditioning], clip: Union[Slot[Clip], Clip], gligen_textbox_model: Union[Slot[Any], Any], text: str, width: int = 64, height: int = 64, x: int = 0, y: int = 0):
