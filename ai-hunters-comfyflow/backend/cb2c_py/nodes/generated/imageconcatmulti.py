...
with the **inputcount** and clicking update.
    ...
    def __init__(self, image_1: Union[Slot[Image], Image], image_2: Union[Slot[Image], Image], inputcount: int = 2, direction: Union[Union[Literal['right', 'down', 'left', 'up'], str], str] = 'right', match_image_size: bool = False):
