...
class SaveWEBM(Node[SaveWEBMInputs, SaveWEBMOutputs]):
    ...
    Inputs:
        ...
        - codec (Union[Literal['vp9', 'av1', str)
    ...
    def __init__(self, images: Union[Slot[Image], Image], codec: Union[Literal['vp9', 'av1'], str], filename_prefix: str = 'ComfyUI', fps: float = 24.0, crf: float = 32.0):
