...
class VHS_PruneOutputsInputs(InputSlots):
    filenames: Slot[Any]
    options: Slot[Union[Literal['Intermediate', 'Intermediate and Utility'], str]]
    def __init__(self, node: "Node"):
        self.filenames = Slot[Any](node, "filenames", 'VHS_FILENAMES')
        self.options = Slot[Union[Literal['Intermediate', 'Intermediate and Utility'], str]](node, "options", ['Intermediate', 'Intermediate and Utility'])
...
class VHS_PruneOutputs(Node[VHS_PruneOutputsInputs, VHS_PruneOutputsOutputs]):
    ...
    Inputs:
        - filenames (Any)
        - options (Union[Literal['Intermediate', 'Intermediate and Utility', str)
    ...
    def __init__(self, filenames: Union[Slot[Any], Any], options: Union[Literal['Intermediate', 'Intermediate and Utility'], str]):
