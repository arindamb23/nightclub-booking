...
class LeapfusionHunyuanI2VPatcher(Node[LeapfusionHunyuanI2VPatcherInputs, LeapfusionHunyuanI2VPatcherOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], latent: Union[Slot[Latent], Latent], index: int = 0, start_percent: float = 0.0, end_percent: float = 1.0, strength: float = 1.0):
