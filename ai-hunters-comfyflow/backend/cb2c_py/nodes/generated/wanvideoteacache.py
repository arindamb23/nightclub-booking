...
class WanVideoTeaCacheInputs(InputSlots):
    ...
    mode: Slot[Union[Union[Literal['e', 'e0'], str], str]]
    def __init__(self, node: "Node"):
        ...
        self.mode = Slot[Union[Union[Literal['e', 'e0'], str], str]](node, "mode", ['e', 'e0'])
...
+-------------------+--------+---------+--------+
    ...
    Inputs:
        ...
        - mode (Union[Literal['e', 'e0', str) (default: 'e')
    ...
    def __init__(self, rel_l1_thresh: float = 0.3, start_step: int = 1, end_step: int = -1, cache_device: Union[Union[Literal['main_device', 'offload_device'], str], str] = 'offload_device', use_coefficients: bool = True, mode: Union[Union[Literal['e', 'e0'], str], str] = 'e'):
        super().__init__(**{"rel_l1_thresh": rel_l1_thresh, "start_step": start_step, "end_step": end_step, "cache_device": cache_device, "use_coefficients": use_coefficients, "mode": mode})
