...
class ImageCompositeMasked(Node[ImageCompositeMaskedInputs, ImageCompositeMaskedOutputs]):
    ...
    def __init__(self, destination: Union[Slot[Image], Image], source: Union[Slot[Image], Image], x: int = 0, y: int = 0, resize_source: bool = False, mask: Optional[Union[Slot[Image], Image]] = None):
