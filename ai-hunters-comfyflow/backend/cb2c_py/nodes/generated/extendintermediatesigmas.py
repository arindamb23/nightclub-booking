...
class ExtendIntermediateSigmasInputs(InputSlots):
    ...
    spacing: Slot[Union[Literal['linear', 'cosine', 'sine'], str]]
    def __init__(self, node: "Node"):
        ...
        self.spacing = Slot[Union[Literal['linear', 'cosine', 'sine'], str]](node, "spacing", ['linear', 'cosine', 'sine'])
...
class ExtendIntermediateSigmas(Node[ExtendIntermediateSigmasInputs, ExtendIntermediateSigmasOutputs]):
    ...
    Inputs:
        ...
        - spacing (Union[Literal['linear', 'cosine', 'sine', str)
    ...
    def __init__(self, sigmas: Union[Slot[Any], Any], spacing: Union[Literal['linear', 'cosine', 'sine'], str], steps: int = 2, start_at_sigma: float = -1.0, end_at_sigma: float = 12.0):
