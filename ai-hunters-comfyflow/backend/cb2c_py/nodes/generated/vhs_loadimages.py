...
class VHS_LoadImagesInputs(InputSlots):
    directory: Slot[Union[Literal['3d'], str]]
    image_load_cap: Slot[int]
    skip_first_images: Slot[int]
    select_every_nth: Slot[int]
    meta_batch: Slot[Any]
    def __init__(self, node: "Node"):
        self.directory = Slot[Union[Literal['3d'], str]](node, "directory", ['3d'])
...
class VHS_LoadImages(Node[VHS_LoadImagesInputs, VHS_LoadImagesOutputs]):
    ...
    Inputs:
        - directory (Union[Literal['3d', str)
    ...
    def __init__(self, directory: Union[Literal['3d'], str], image_load_cap: int = 0, skip_first_images: int = 0, select_every_nth: int = 1, meta_batch: Optional[Union[Slot[Any], Any]] = None):
        super().__init__(**{"directory": directory, "image_load_cap": image_load_cap, "skip_first_images": skip_first_images, "select_every_nth": select_every_nth, "meta_batch": meta_batch})
