...
class VHS_LoadAudioInputs(InputSlots):
    audio_file: Slot[str]
    seek_seconds: Slot[Union[float, int]]
    duration: Slot[Union[float, int]]
    def __init__(self, node: "Node"):
        self.audio_file = Slot[str](node, "audio_file", 'STRING')
        self.seek_seconds = Slot[Union[float, int]](node, "seek_seconds", 'FLOAT')
...
class VHS_LoadAudio(Node[VHS_LoadAudioInputs, VHS_LoadAudioOutputs]):
    ...
    def __init__(self, audio_file: str = 'input/', seek_seconds: Union[float, int] = 0, duration: Union[float, int] = 0):
        super().__init__(**{"audio_file": audio_file, "seek_seconds": seek_seconds, "duration": duration})
