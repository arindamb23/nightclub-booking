...
class CLIPTextEncodeSD3Inputs(InputSlots):
    ...
    clip_g: Slot[str]
    t5xxl: Slot[str]
    empty_padding: Slot[Union[Literal['none', 'empty_prompt'], str]]
    def __init__(self, node: "Node"):
        ...
        self.empty_padding = Slot[Union[Literal['none', 'empty_prompt'], str]](node, "empty_padding", ['none', 'empty_prompt'])
...
class CLIPTextEncodeSD3(Node[CLIPTextEncodeSD3Inputs, CLIPTextEncodeSD3Outputs]):
    ...
    Inputs:
        ...
        - clip_g (str)
        - t5xxl (str)
        - empty_padding (Union[Literal['none', 'empty_prompt', str)
    ...
    def __init__(self, clip: Union[Slot[Clip], Clip], clip_l: str, clip_g: str, t5xxl: str, empty_padding: Union[Literal['none', 'empty_prompt'], str]):
