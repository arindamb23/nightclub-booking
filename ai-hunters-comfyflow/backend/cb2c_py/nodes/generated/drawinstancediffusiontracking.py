...
CreateInstanceDiffusionTracking -node.
    ...
    def __init__(self, image: Union[Slot[Image], Image], tracking: Union[Slot[Any], Any], font: Union[Literal['FreeMono.ttf', 'FreeMonoBoldOblique.otf', 'TTNorms-Black.otf'], str], box_line_width: int = 2, draw_text: bool = True, font_size: int = 20):
