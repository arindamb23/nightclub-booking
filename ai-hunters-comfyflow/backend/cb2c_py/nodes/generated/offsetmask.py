...
class OffsetMaskInputs(InputSlots):
    ...
    padding_mode: Slot[Union[Union[Literal['empty', 'border', 'reflection'], str], str]]
    def __init__(self, node: "Node"):
        ...
        self.padding_mode = Slot[Union[Union[Literal['empty', 'border', 'reflection'], str], str]](node, "padding_mode", ['empty', 'border', 'reflection'])
...
Offsets the mask by the specified amount.  
 ...
 - border padding_mode: Padding mode for the mask
    ...
    Inputs:
        ...
        - padding_mode (Union[Literal['empty', 'border', 'reflection', str) (default: 'empty')
    ...
    def __init__(self, mask: Union[Slot[Image], Image], x: int = 0, y: int = 0, angle: int = 0, duplication_factor: int = 1, roll: bool = False, incremental: bool = False, padding_mode: Union[Union[Literal['empty', 'border', 'reflection'], str], str] = 'empty'):
