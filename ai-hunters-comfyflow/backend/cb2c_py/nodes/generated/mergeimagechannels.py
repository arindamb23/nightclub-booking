...
Merges channel data into an image.  
    ...
    def __init__(self, red: Union[Slot[Image], Image], green: Union[Slot[Image], Image], blue: Union[Slot[Image], Image], alpha: Union[Slot[Image], Image] = None):
