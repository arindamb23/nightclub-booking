...
class ImagePadForOutpaintMasked(Node[ImagePadForOutpaintMaskedInputs, ImagePadForOutpaintMaskedOutputs]):
    ...
    def __init__(self, image: Union[Slot[Image], Image], left: int = 0, top: int = 0, right: int = 0, bottom: int = 0, feathering: int = 0, mask: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"image": image, "left": left, "top": top, "right": right, "bottom": bottom, "feathering": feathering, "mask": mask})
