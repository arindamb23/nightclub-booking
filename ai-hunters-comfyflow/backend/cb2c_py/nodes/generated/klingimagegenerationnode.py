...
class KlingImageGenerationNode(Node[KlingImageGenerationNodeInputs, KlingImageGenerationNodeOutputs]):
    ...
    def __init__(self, prompt: str, negative_prompt: str = None, image_type: str = 'None', image_fidelity: float = 0.5, human_fidelity: float = 0.45, model_name: str = 'kling-v1', aspect_ratio: str = '16:9', n: int = 1, image: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"prompt": prompt, "negative_prompt": negative_prompt, "image_type": image_type, "image_fidelity": image_fidelity, "human_fidelity": human_fidelity, "model_name": model_name, "aspect_ratio": aspect_ratio, "n": n, "image": image})
