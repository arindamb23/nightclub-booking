...
class FluxProCannyNode(Node[FluxProCannyNodeInputs, FluxProCannyNodeOutputs]):
    ...
    def __init__(self, control_image: Union[Slot[Image], Image], prompt: str = '', prompt_upsampling: bool = False, canny_low_threshold: float = 0.1, canny_high_threshold: float = 0.4, skip_preprocessing: bool = False, guidance: Union[float, int] = 30, steps: int = 50, seed: int = 0):
