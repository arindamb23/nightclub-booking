...
class StabilityUpscaleConservativeNode(Node[StabilityUpscaleConservativeNodeInputs, StabilityUpscaleConservativeNodeOutputs]):
    ...
    def __init__(self, image: Union[Slot[Image], Image], prompt: str = '', creativity: float = 0.35, seed: int = 0, negative_prompt: str = ''):
        super().__init__(**{"image": image, "prompt": prompt, "creativity": creativity, "seed": seed, "negative_prompt": negative_prompt})
