...
class FluxProDepthNode(Node[FluxProDepthNodeInputs, FluxProDepthNodeOutputs]):
    ...
    def __init__(self, control_image: Union[Slot[Image], Image], prompt: str = '', prompt_upsampling: bool = False, skip_preprocessing: bool = False, guidance: Union[float, int] = 15, steps: int = 50, seed: int = 0):
