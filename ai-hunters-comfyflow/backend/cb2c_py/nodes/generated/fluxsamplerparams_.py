...
class FluxSamplerParams_Inputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.loras = Slot[Any](node, "loras", 'LORA_PARAMS')
...
class FluxSamplerParams_(Node[FluxSamplerParams_Inputs, FluxSamplerParams_Outputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], conditioning: Union[Slot[Conditioning], Conditioning], latent_image: Union[Slot[Latent], Latent], seed: str = '?', sampler: str = 'euler', scheduler: str = 'simple', steps: str = '20', guidance: str = '3.5', max_shift: str = '', base_shift: str = '', denoise: str = '1.0', loras: Optional[Union[Slot[Any], Any]] = None):
        super().__init__(**{"model": model, "conditioning": conditioning, "latent_image": latent_image, "seed": seed, "sampler": sampler, "scheduler": scheduler, "steps": steps, "guidance": guidance, "max_shift": max_shift, "base_shift": base_shift, "denoise": denoise, "loras": loras})
