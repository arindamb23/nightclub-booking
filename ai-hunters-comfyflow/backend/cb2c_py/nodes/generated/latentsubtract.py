...
# Define input and output slot classes for LatentSubtract
class LatentSubtractInputs(InputSlots):
...
class LatentSubtractOutputs(OutputSlots):
    latent: Slot[Latent]
    def __init__(self, node: "Node"):
...
class LatentSubtract(Node[LatentSubtractInputs, LatentSubtractOutputs]):
    ...
    def __init__(self, samples1: Union[Slot[Latent], Latent], samples2: Union[Slot[Latent], Latent]):
        ...
        self.inputs = LatentSubtractInputs(self)
        self.outputs = LatentSubtractOutputs(self)
