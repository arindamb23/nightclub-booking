...
class AudioConcatenateInputs(InputSlots):
    audio1: Slot[Any]
    audio2: Slot[Any]
    direction: Slot[Union[Union[Literal['right', 'left'], str], str]]
    def __init__(self, node: "Node"):
        self.audio1 = Slot[Any](node, "audio1", 'AUDIO')
        self.audio2 = Slot[Any](node, "audio2", 'AUDIO')
        self.direction = Slot[Union[Union[Literal['right', 'left'], str], str]](node, "direction", ['right', 'left'])
...
Concatenates the audio1 to audio2 in the specified direction.
    ...
    Inputs:
        - audio1 (Any)
        - audio2 (Any)
        - direction (Union[Literal['right', 'left', str) (default: 'right')
    ...
    def __init__(self, audio1: Union[Slot[Any], Any], audio2: Union[Slot[Any], Any], direction: Union[Union[Literal['right', 'left'], str], str] = 'right'):
