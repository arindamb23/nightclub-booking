...
class ModelSamplingDiscreteInputs(InputSlots):
    model: Slot[Model]
    sampling: Slot[Union[Literal['eps', 'v_prediction', 'lcm', 'x0', 'img_to_img'], str]]
    zsnr: Slot[bool]
    def __init__(self, node: "Node"):
        self.model = Slot[Model](node, "model", 'MODEL')
        self.sampling = Slot[Union[Literal['eps', 'v_prediction', 'lcm', 'x0', 'img_to_img'], str]](node, "sampling", ['eps', 'v_prediction', 'lcm', 'x0', 'img_to_img'])
...
class ModelSamplingDiscrete(Node[ModelSamplingDiscreteInputs, ModelSamplingDiscreteOutputs]):
    ...
    Inputs:
        - model (Model)
        - sampling (Union[Literal['eps', 'v_prediction', 'lcm', 'x0', 'img_to_img', str)
    ...
    def __init__(self, model: Union[Slot[Model], Model], sampling: Union[Literal['eps', 'v_prediction', 'lcm', 'x0', 'img_to_img'], str], zsnr: bool = False):
