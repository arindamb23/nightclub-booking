...
class FluxProExpandNode(Node[FluxProExpandNodeInputs, FluxProExpandNodeOutputs]):
    ...
    def __init__(self, image: Union[Slot[Image], Image], prompt: str = '', prompt_upsampling: bool = False, top: int = 0, bottom: int = 0, left: int = 0, right: int = 0, guidance: Union[float, int] = 60, steps: int = 50, seed: int = 0):
