...
Concatenates the image2 to image1 in the specified direction.
    ...
    def __init__(self, image1: Union[Slot[Image], Image], image2: Union[Slot[Image], Image], direction: Union[Union[Literal['right', 'down', 'left', 'up'], str], str] = 'right', match_image_size: bool = True):
