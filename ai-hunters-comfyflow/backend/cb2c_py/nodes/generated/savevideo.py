...
class SaveVideoInputs(InputSlots):
    ...
    format: Slot[Union[Union[Literal['auto', 'mp4'], str], str]]
    codec: Slot[Union[Union[Literal['auto', 'h264'], str], str]]
    def __init__(self, node: "Node"):
        self.video = Slot[Any](node, "video", 'VIDEO')
        self.filename_prefix = Slot[str](node, "filename_prefix", 'STRING')
        self.format = Slot[Union[Union[Literal['auto', 'mp4'], str], str]](node, "format", ['auto', 'mp4'])
        self.codec = Slot[Union[Union[Literal['auto', 'h264'], str], str]](node, "codec", ['auto', 'h264'])
...
class SaveVideo(Node[SaveVideoInputs, SaveVideoOutputs]):
    ...
    Inputs:
        ...
        - format (Union[Literal['auto', 'mp4', str) (default: 'auto')
          The format to save the video as.
        - codec (Union[Literal['auto', 'h264', str) (default: 'auto')
    ...
    def __init__(self, video: Union[Slot[Any], Any], filename_prefix: str = 'video/ComfyUI', format: Union[Union[Literal['auto', 'mp4'], str], str] = 'auto', codec: Union[Union[Literal['auto', 'h264'], str], str] = 'auto'):
