...
original_images (optional): If provided, need have same length as masks.
    ...
    def __init__(self, masks: Union[Slot[Image], Image], original_images: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"masks": masks, "original_images": original_images})
