...
class CFGGuider(Node[CFGGuiderInputs, CFGGuiderOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], cfg: float = 8.0):
