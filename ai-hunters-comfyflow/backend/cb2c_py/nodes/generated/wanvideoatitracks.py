...
class WanVideoATITracks(Node[WanVideoATITracksInputs, WanVideoATITracksOutputs]):
    ...
    def __init__(self, model: Union[Slot[Any], Any], tracks: str, width: int = 832, height: int = 480, temperature: float = 220.0, topk: int = 2, start_percent: float = 0.0, end_percent: float = 1.0):
