...
class RenormCFGInputs(InputSlots):
    model: Slot[Model]
    cfg_trunc: Slot[Union[float, int]]
    renorm_cfg: Slot[float]
    def __init__(self, node: "Node"):
        self.model = Slot[Model](node, "model", 'MODEL')
        self.cfg_trunc = Slot[Union[float, int]](node, "cfg_trunc", 'FLOAT')
...
class RenormCFG(Node[RenormCFGInputs, RenormCFGOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], cfg_trunc: Union[float, int] = 100, renorm_cfg: float = 1.0):
