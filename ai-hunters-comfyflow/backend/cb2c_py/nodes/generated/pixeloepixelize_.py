...
class PixelOEPixelize_Inputs(InputSlots):
    image: Slot[Image]
    downscale_mode: Slot[Union[Literal['contrast', 'bicubic', 'nearest', 'center', 'k-centroid'], str]]
    ...
    def __init__(self, node: "Node"):
        ...
        self.downscale_mode = Slot[Union[Literal['contrast', 'bicubic', 'nearest', 'center', 'k-centroid'], str]](node, "downscale_mode", ['contrast', 'bicubic', 'nearest', 'center', 'k-centroid'])
...
class PixelOEPixelize_(Node[PixelOEPixelize_Inputs, PixelOEPixelize_Outputs]):
    ...
    Inputs:
        - image (Image)
        - downscale_mode (Union[Literal['contrast', 'bicubic', 'nearest', 'center', 'k-centroid', str)
    ...
    def __init__(self, image: Union[Slot[Image], Image], downscale_mode: Union[Literal['contrast', 'bicubic', 'nearest', 'center', 'k-centroid'], str], target_size: int = 128, patch_size: int = 16, thickness: int = 2, color_matching: bool = True, upscale: bool = True):
