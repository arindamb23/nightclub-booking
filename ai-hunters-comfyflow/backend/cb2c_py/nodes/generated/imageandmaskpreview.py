...
nodes for example.
    ...
    def __init__(self, mask_opacity: float = 1.0, mask_color: str = '255, 255, 255', pass_through: bool = False, image: Optional[Union[Slot[Image], Image]] = None, mask: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"mask_opacity": mask_opacity, "mask_color": mask_color, "pass_through": pass_through, "image": image, "mask": mask})
