...
class VAEDecodeTiled(Node[VAEDecodeTiledInputs, VAEDecodeTiledOutputs]):
    ...
    def __init__(self, samples: Union[Slot[Latent], Latent], vae: Union[Slot[Vae], Vae], tile_size: int = 512, overlap: int = 64, temporal_size: int = 64, temporal_overlap: int = 8):
