...
class VHS_MergeImages(Node[VHS_MergeImagesInputs, VHS_MergeImagesOutputs]):
    ...
    def __init__(self, images_A: Union[Slot[Image], Image], images_B: Union[Slot[Image], Image], merge_strategy: Union[Literal['match A', 'match B', 'match smaller', 'match larger'], str], scale_method: Union[Literal['nearest-exact', 'bilinear', 'area', 'bicubic', 'bislerp'], str], crop: Union[Literal['disabled', 'center'], str]):
