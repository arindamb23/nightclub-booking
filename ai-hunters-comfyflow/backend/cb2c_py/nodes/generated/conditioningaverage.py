...
class ConditioningAverage(Node[ConditioningAverageInputs, ConditioningAverageOutputs]):
    ...
    def __init__(self, conditioning_to: Union[Slot[Conditioning], Conditioning], conditioning_from: Union[Slot[Conditioning], Conditioning], conditioning_to_strength: float = 1.0):
