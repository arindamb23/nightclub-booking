...
class WanVideoNAG(Node[WanVideoNAGInputs, WanVideoNAGOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], conditioning: Union[Slot[Conditioning], Conditioning], nag_scale: float = 11.0, nag_alpha: float = 0.25, nag_tau: float = 2.5):
