...
class HintImageEnchance(Node[HintImageEnchanceInputs, HintImageEnchanceOutputs]):
    ...
    def __init__(self, hint_image: Union[Slot[Image], Image], image_gen_width: int = 512, image_gen_height: int = 512, resize_mode: Union[Union[Literal['Just Resize', 'Crop and Resize', 'Resize and Fill'], str], str] = 'Just Resize'):
