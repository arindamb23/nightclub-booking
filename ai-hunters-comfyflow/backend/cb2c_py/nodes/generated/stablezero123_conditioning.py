...
class StableZero123_Conditioning(Node[StableZero123_ConditioningInputs, StableZero123_ConditioningOutputs]):
    ...
    def __init__(self, clip_vision: Union[Slot[Any], Any], init_image: Union[Slot[Image], Image], vae: Union[Slot[Vae], Vae], width: int = 256, height: int = 256, batch_size: int = 1, elevation: float = 0.0, azimuth: float = 0.0):
