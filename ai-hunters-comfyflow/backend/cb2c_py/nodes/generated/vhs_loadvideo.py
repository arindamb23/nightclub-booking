...
class VHS_LoadVideoInputs(InputSlots):
    ...
    meta_batch: Slot[Any]
    vae: Slot[Vae]
    format: Slot[Union[Union[Literal['None', 'AnimateDiff', 'Mochi', 'LTXV', 'Hunyuan', 'Cosmos', 'Wan'], str], str]]
    def __init__(self, node: "Node"):
        ...
        self.format = Slot[Union[Union[Literal['None', 'AnimateDiff', 'Mochi', 'LTXV', 'Hunyuan', 'Cosmos', 'Wan'], str], str]](node, "format", ['None', 'AnimateDiff', 'Mochi', 'LTXV', 'Hunyuan', 'Cosmos', 'Wan'])
...
class VHS_LoadVideo(Node[VHS_LoadVideoInputs, VHS_LoadVideoOutputs]):
    ...
    Inputs:
        ...
        - meta_batch (Any)
        - vae (Vae)
        - format (Union[Literal['None', 'AnimateDiff', 'Mochi', 'LTXV', 'Hunyuan', 'Cosmos', 'Wan', str) (default: 'AnimateDiff')
    ...
    def __init__(self, video: str, force_rate: Union[float, int] = 0, custom_width: int = 0, custom_height: int = 0, frame_load_cap: int = 0, skip_first_frames: int = 0, select_every_nth: int = 1, meta_batch: Optional[Union[Slot[Any], Any]] = None, vae: Optional[Union[Slot[Vae], Vae]] = None, format: Union[Union[Literal['None', 'AnimateDiff', 'Mochi', 'LTXV', 'Hunyuan', 'Cosmos', 'Wan'], str], str] = 'AnimateDiff'):
        super().__init__(**{"video": video, "force_rate": force_rate, "custom_width": custom_width, "custom_height": custom_height, "frame_load_cap": frame_load_cap, "skip_first_frames": skip_first_frames, "select_every_nth": select_every_nth, "meta_batch": meta_batch, "vae": vae, "format": format})
