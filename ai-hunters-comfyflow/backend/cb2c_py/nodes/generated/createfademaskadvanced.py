...
class CreateFadeMaskAdvancedInputs(InputSlots):
    ...
    width: Slot[int]
    height: Slot[int]
    interpolation: Slot[Union[Literal['linear', 'ease_in', 'ease_out', 'ease_in_out', 'none', 'default_to_black'], str]]
    def __init__(self, node: "Node"):
        ...
        self.interpolation = Slot[Union[Literal['linear', 'ease_in', 'ease_out', 'ease_in_out', 'none', 'default_to_black'], str]](node, "interpolation", ['linear', 'ease_in', 'ease_out', 'ease_in_out', 'none', 'default_to_black'])
...
and interpolating from that to fully black at the 16th frame.
    ...
    Inputs:
        ...
        - interpolation (Union[Literal['linear', 'ease_in', 'ease_out', 'ease_in_out', 'none', 'default_to_black', str)
    ...
    def __init__(self, interpolation: Union[Literal['linear', 'ease_in', 'ease_out', 'ease_in_out', 'none', 'default_to_black'], str], points_string: str = '0:(0.0),\n7:(1.0),\n15:(0.0)\n', invert: bool = False, frames: int = 16, width: int = 512, height: int = 512):
