...
class SV3D_Conditioning(Node[SV3D_ConditioningInputs, SV3D_ConditioningOutputs]):
    ...
    def __init__(self, clip_vision: Union[Slot[Any], Any], init_image: Union[Slot[Image], Image], vae: Union[Slot[Vae], Vae], width: int = 576, height: int = 576, video_frames: int = 21, elevation: float = 0.0):
