...
class CLIPTextEncodeSDXL(Node[CLIPTextEncodeSDXLInputs, CLIPTextEncodeSDXLOutputs]):
    ...
    Inputs:
        ...
        - target_width (int) (default: 1024.0)
        - target_height (int) (default: 1024.0)
        - text_g (str)
        - text_l (str)
    ...
    def __init__(self, clip: Union[Slot[Clip], Clip], text_g: str, text_l: str, width: Union[int, float] = 1024.0, height: Union[int, float] = 1024.0, crop_w: int = 0, crop_h: int = 0, target_width: Union[int, float] = 1024.0, target_height: Union[int, float] = 1024.0):
