...
class LTXVScheduler(Node[LTXVSchedulerInputs, LTXVSchedulerOutputs]):
    ...
    def __init__(self, steps: int = 20, max_shift: float = 2.05, base_shift: float = 0.95, stretch: bool = True, terminal: float = 0.1, latent: Optional[Union[Slot[Latent], Latent]] = None):
        super().__init__(**{"steps": steps, "max_shift": max_shift, "base_shift": base_shift, "stretch": stretch, "terminal": terminal, "latent": latent})
