...
class ImageBlendInputs(InputSlots):
    ...
    blend_mode: Slot[Union[Literal['normal', 'multiply', 'screen', 'overlay', 'soft_light', 'difference'], str]]
    def __init__(self, node: "Node"):
        ...
        self.blend_mode = Slot[Union[Literal['normal', 'multiply', 'screen', 'overlay', 'soft_light', 'difference'], str]](node, "blend_mode", ['normal', 'multiply', 'screen', 'overlay', 'soft_light', 'difference'])
...
class ImageBlend(Node[ImageBlendInputs, ImageBlendOutputs]):
    ...
    Inputs:
        ...
        - blend_mode (Union[Literal['normal', 'multiply', 'screen', 'overlay', 'soft_light', 'difference', str)
    ...
    def __init__(self, image1: Union[Slot[Image], Image], image2: Union[Slot[Image], Image], blend_mode: Union[Literal['normal', 'multiply', 'screen', 'overlay', 'soft_light', 'difference'], str], blend_factor: float = 0.5):
