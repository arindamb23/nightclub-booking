...
class SamplerCustomAdvanced(Node[SamplerCustomAdvancedInputs, SamplerCustomAdvancedOutputs]):
    ...
    def __init__(self, noise: Union[Slot[Any], Any], guider: Union[Slot[Any], Any], sampler: Union[Slot[Any], Any], sigmas: Union[Slot[Any], Any], latent_image: Union[Slot[Latent], Latent]):
