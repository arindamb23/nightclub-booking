...
class VHS_MergeMasks(Node[VHS_MergeMasksInputs, VHS_MergeMasksOutputs]):
    ...
    def __init__(self, mask_A: Union[Slot[Image], Image], mask_B: Union[Slot[Image], Image], merge_strategy: Union[Literal['match A', 'match B', 'match smaller', 'match larger'], str], scale_method: Union[Literal['nearest-exact', 'bilinear', 'area', 'bicubic', 'bislerp'], str], crop: Union[Literal['disabled', 'center'], str]):
