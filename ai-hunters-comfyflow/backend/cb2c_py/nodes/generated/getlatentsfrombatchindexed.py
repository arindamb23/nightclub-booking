...
class GetLatentsFromBatchIndexedInputs(InputSlots):
    latents: Slot[Latent]
    indexes: Slot[str]
    latent_format: Slot[Union[Union[Literal['BCHW', 'BTCHW', 'BCTHW'], str], str]]
    def __init__(self, node: "Node"):
        self.latents = Slot[Latent](node, "latents", 'LATENT')
        self.indexes = Slot[str](node, "indexes", 'STRING')
        self.latent_format = Slot[Union[Union[Literal['BCHW', 'BTCHW', 'BCTHW'], str], str]](node, "latent_format", ['BCHW', 'BTCHW', 'BCTHW'])
...
Selects and returns the latents at the specified indices as an latent batch.
    ...
    Inputs:
        ...
        - latent_format (Union[Literal['BCHW', 'BTCHW', 'BCTHW', str) (default: 'BCHW')
    ...
    def __init__(self, latents: Union[Slot[Latent], Latent], indexes: str = '0, 1, 2', latent_format: Union[Union[Literal['BCHW', 'BTCHW', 'BCTHW'], str], str] = 'BCHW'):
