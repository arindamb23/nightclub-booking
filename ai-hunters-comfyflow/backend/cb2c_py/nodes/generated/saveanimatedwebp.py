...
class SaveAnimatedWEBPInputs(InputSlots):
    ...
    lossless: Slot[bool]
    quality: Slot[int]
    method: Slot[Union[Literal['default', 'fastest', 'slowest'], str]]
    def __init__(self, node: "Node"):
        ...
        self.method = Slot[Union[Literal['default', 'fastest', 'slowest'], str]](node, "method", ['default', 'fastest', 'slowest'])
...
class SaveAnimatedWEBP(Node[SaveAnimatedWEBPInputs, SaveAnimatedWEBPOutputs]):
    ...
    Inputs:
        ...
        - method (Union[Literal['default', 'fastest', 'slowest', str)
    ...
    def __init__(self, images: Union[Slot[Image], Image], method: Union[Literal['default', 'fastest', 'slowest'], str], filename_prefix: str = 'ComfyUI', fps: float = 6.0, lossless: bool = True, quality: int = 80):
