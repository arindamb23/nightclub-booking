...
class ImageCropByMaskBatch(Node[ImageCropByMaskBatchInputs, ImageCropByMaskBatchOutputs]):
    ...
    def __init__(self, image: Union[Slot[Image], Image], masks: Union[Slot[Image], Image], width: int = 512, height: int = 512, padding: int = 0, preserve_size: bool = False, bg_color: str = '0, 0, 0'):
