...
class SamplerDPMPP_2M_SDEInputs(InputSlots):
    solver_type: Slot[Union[Literal['midpoint', 'heun'], str]]
    eta: Slot[float]
    s_noise: Slot[float]
    noise_device: Slot[Union[Literal['gpu', 'cpu'], str]]
    def __init__(self, node: "Node"):
        self.solver_type = Slot[Union[Literal['midpoint', 'heun'], str]](node, "solver_type", ['midpoint', 'heun'])
        self.eta = Slot[float](node, "eta", 'FLOAT')
        self.s_noise = Slot[float](node, "s_noise", 'FLOAT')
        self.noise_device = Slot[Union[Literal['gpu', 'cpu'], str]](node, "noise_device", ['gpu', 'cpu'])
...
class SamplerDPMPP_2M_SDE(Node[SamplerDPMPP_2M_SDEInputs, SamplerDPMPP_2M_SDEOutputs]):
    ...
    Inputs:
        - solver_type (Union[Literal['midpoint', 'heun', str)
        - eta (float) (default: 1.0)
        - s_noise (float) (default: 1.0)
        - noise_device (Union[Literal['gpu', 'cpu', str)
    ...
    def __init__(self, solver_type: Union[Literal['midpoint', 'heun'], str], noise_device: Union[Literal['gpu', 'cpu'], str], eta: float = 1.0, s_noise: float = 1.0):
