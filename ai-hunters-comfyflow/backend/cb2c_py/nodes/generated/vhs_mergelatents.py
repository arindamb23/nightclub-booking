...
class VHS_MergeLatentsInputs(InputSlots):
    ...
    merge_strategy: Slot[Union[Literal['match A', 'match B', 'match smaller', 'match larger'], str]]
    scale_method: Slot[Union[Literal['nearest-exact', 'bilinear', 'area', 'bicubic', 'bislerp'], str]]
    ...
    def __init__(self, node: "Node"):
        ...
        self.merge_strategy = Slot[Union[Literal['match A', 'match B', 'match smaller', 'match larger'], str]](node, "merge_strategy", ['match A', 'match B', 'match smaller', 'match larger'])
        self.scale_method = Slot[Union[Literal['nearest-exact', 'bilinear', 'area', 'bicubic', 'bislerp'], str]](node, "scale_method", ['nearest-exact', 'bilinear', 'area', 'bicubic', 'bislerp'])
...
class VHS_MergeLatents(Node[VHS_MergeLatentsInputs, VHS_MergeLatentsOutputs]):
    ...
    Inputs:
        - latents_A (Latent)
        - latents_B (Latent)
        - merge_strategy (Union[Literal['match A', 'match B', 'match smaller', 'match larger', str)
        - scale_method (Union[Literal['nearest-exact', 'bilinear', 'area', 'bicubic', 'bislerp', str)
    ...
    def __init__(self, latents_A: Union[Slot[Latent], Latent], latents_B: Union[Slot[Latent], Latent], merge_strategy: Union[Literal['match A', 'match B', 'match smaller', 'match larger'], str], scale_method: Union[Literal['nearest-exact', 'bilinear', 'area', 'bicubic', 'bislerp'], str], crop: Union[Literal['disabled', 'center'], str]):
