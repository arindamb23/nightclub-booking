...
class ConditioningMultiCombineInputs(InputSlots):
    inputcount: Slot[int]
    operation: Slot[Union[Union[Literal['combine', 'concat'], str], str]]
    conditioning_1: Slot[Conditioning]
    conditioning_2: Slot[Conditioning]
    def __init__(self, node: "Node"):
        self.inputcount = Slot[int](node, "inputcount", 'INT')
        self.operation = Slot[Union[Union[Literal['combine', 'concat'], str], str]](node, "operation", ['combine', 'concat'])
...
Combines multiple conditioning nodes into one
    ...
    Inputs:
        ...
        - operation (Union[Literal['combine', 'concat', str) (default: 'combine')
    ...
    def __init__(self, conditioning_1: Union[Slot[Conditioning], Conditioning], conditioning_2: Union[Slot[Conditioning], Conditioning], inputcount: int = 2, operation: Union[Union[Literal['combine', 'concat'], str], str] = 'combine'):
