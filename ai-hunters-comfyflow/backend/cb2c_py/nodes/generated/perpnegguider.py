...
class PerpNegGuider(Node[PerpNegGuiderInputs, PerpNegGuiderOutputs]):
    ...
    def __init__(self, model: Union[Slot[Model], Model], positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], empty_conditioning: Union[Slot[Conditioning], Conditioning], cfg: float = 8.0, neg_scale: float = 1.0):
