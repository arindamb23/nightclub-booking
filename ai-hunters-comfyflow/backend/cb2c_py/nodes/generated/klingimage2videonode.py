...
class KlingImage2VideoNode(Node[KlingImage2VideoNodeInputs, KlingImage2VideoNodeOutputs]):
    ...
    def __init__(self, start_frame: Union[Slot[Image], Image] = None, prompt: str = None, negative_prompt: str = None, model_name: str = 'kling-v2-master', cfg_scale: float = 0.8, mode: str = 'std', aspect_ratio: str = '16:9', duration: str = '5'):
