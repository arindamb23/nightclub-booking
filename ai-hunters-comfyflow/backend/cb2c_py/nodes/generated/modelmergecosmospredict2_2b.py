...
# Define input and output slot classes for ModelMergeCosmosPredict2_2B
class ModelMergeCosmosPredict2_2BInputs(InputSlots):
    model1: Slot[Model]
    model2: Slot[Model]
...
class ModelMergeCosmosPredict2_2BOutputs(OutputSlots):
    model: Slot[Model]
    def __init__(self, node: "Node"):
        self.model = Slot[Model](node, "MODEL", 'MODEL')

class ModelMergeCosmosPredict2_2B(Node[ModelMergeCosmosPredict2_2BInputs, ModelMergeCosmosPredict2_2BOutputs]):
    """
    Original name: ModelMergeCosmosPredict2_2B
    ...
    Inputs:
        ...
        - t_embedding_norm_ (float) (default: 1.0)
