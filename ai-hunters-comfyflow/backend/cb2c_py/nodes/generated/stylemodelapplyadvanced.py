...
class StyleModelApplyAdvanced(Node[StyleModelApplyAdvancedInputs, StyleModelApplyAdvancedOutputs]):
    ...
    def __init__(self, conditioning: Union[Slot[Conditioning], Conditioning], style_model: Union[Slot[Any], Any], clip_vision_output: Union[Slot[Any], Any], strength: float = 1.0):
