...
class SD_4XUpscale_Conditioning(Node[SD_4XUpscale_ConditioningInputs, SD_4XUpscale_ConditioningOutputs]):
    ...
    def __init__(self, images: Union[Slot[Image], Image], positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], scale_ratio: float = 4.0, noise_augmentation: float = 0.0):
