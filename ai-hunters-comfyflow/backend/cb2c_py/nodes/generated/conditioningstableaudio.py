...
class ConditioningStableAudio(Node[ConditioningStableAudioInputs, ConditioningStableAudioOutputs]):
    ...
    def __init__(self, positive: Union[Slot[Conditioning], Conditioning], negative: Union[Slot[Conditioning], Conditioning], seconds_start: float = 0.0, seconds_total: float = 47.0):
