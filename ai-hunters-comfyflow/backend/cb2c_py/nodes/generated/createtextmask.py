...
creates animation between them.
    ...
    def __init__(self, font: Union[Literal['FreeMono.ttf', 'FreeMonoBoldOblique.otf', 'TTNorms-Black.otf'], str], invert: bool = False, frames: int = 1, text_x: int = 0, text_y: int = 0, font_size: int = 32, font_color: str = 'white', text: str = 'HELLO!', width: int = 512, height: int = 512, start_rotation: int = 0, end_rotation: int = 0):
