...
class CLIPTextEncodeLumina2Inputs(InputSlots):
    system_prompt: Slot[Union[Literal['superior', 'alignment'], str]]
    user_prompt: Slot[str]
    clip: Slot[Clip]
    def __init__(self, node: "Node"):
        self.system_prompt = Slot[Union[Literal['superior', 'alignment'], str]](node, "system_prompt", ['superior', 'alignment'])
...
class CLIPTextEncodeLumina2(Node[CLIPTextEncodeLumina2Inputs, CLIPTextEncodeLumina2Outputs]):
    ...
    Inputs:
        - system_prompt (Union[Literal['superior', 'alignment', str)
    ...
    def __init__(self, system_prompt: Union[Literal['superior', 'alignment'], str], user_prompt: str, clip: Union[Slot[Clip], Clip]):
