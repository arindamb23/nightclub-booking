...
class SamplerEulerCFGppInputs(InputSlots):
    version: Slot[Union[Literal['regular', 'alternative'], str]]
    def __init__(self, node: "Node"):
        self.version = Slot[Union[Literal['regular', 'alternative'], str]](node, "version", ['regular', 'alternative'])
...
class SamplerEulerCFGpp(Node[SamplerEulerCFGppInputs, SamplerEulerCFGppOutputs]):
    ...
    Inputs:
        - version (Union[Literal['regular', 'alternative', str)
    ...
    def __init__(self, version: Union[Literal['regular', 'alternative'], str]):
