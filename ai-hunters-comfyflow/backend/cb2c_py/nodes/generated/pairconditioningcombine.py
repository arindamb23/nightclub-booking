...
class PairConditioningCombine(Node[PairConditioningCombineInputs, PairConditioningCombineOutputs]):
    ...
    def __init__(self, positive_A: Union[Slot[Conditioning], Conditioning], negative_A: Union[Slot[Conditioning], Conditioning], positive_B: Union[Slot[Conditioning], Conditioning], negative_B: Union[Slot[Conditioning], Conditioning]):
