...
class Pikaswaps(Node[PikaswapsInputs, PikaswapsOutputs]):
    ...
    def __init__(self, video: Union[Slot[Any], Any], image: Union[Slot[Image], Image], mask: Union[Slot[Image], Image], prompt_text: str = None, negative_prompt: str = None, seed: int = None):
