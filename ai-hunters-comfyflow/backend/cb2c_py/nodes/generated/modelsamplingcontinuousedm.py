...
class ModelSamplingContinuousEDMInputs(InputSlots):
    model: Slot[Model]
    sampling: Slot[Union[Literal['v_prediction', 'edm', 'edm_playground_v2.5', 'eps', 'cosmos_rflow'], str]]
    sigma_max: Slot[float]
    sigma_min: Slot[float]
    def __init__(self, node: "Node"):
        self.model = Slot[Model](node, "model", 'MODEL')
        self.sampling = Slot[Union[Literal['v_prediction', 'edm', 'edm_playground_v2.5', 'eps', 'cosmos_rflow'], str]](node, "sampling", ['v_prediction', 'edm', 'edm_playground_v2.5', 'eps', 'cosmos_rflow'])
...
class ModelSamplingContinuousEDM(Node[ModelSamplingContinuousEDMInputs, ModelSamplingContinuousEDMOutputs]):
    ...
    Inputs:
        - model (Model)
        - sampling (Union[Literal['v_prediction', 'edm', 'edm_playground_v2.5', 'eps', 'cosmos_rflow', str)
    ...
    def __init__(self, model: Union[Slot[Model], Model], sampling: Union[Literal['v_prediction', 'edm', 'edm_playground_v2.5', 'eps', 'cosmos_rflow'], str], sigma_max: float = 120.0, sigma_min: float = 0.002):
