...
class SVD_img2vid_Conditioning(Node[SVD_img2vid_ConditioningInputs, SVD_img2vid_ConditioningOutputs]):
    ...
    def __init__(self, clip_vision: Union[Slot[Any], Any], init_image: Union[Slot[Image], Image], vae: Union[Slot[Vae], Vae], width: int = 1024, height: int = 576, video_frames: int = 14, motion_bucket_id: int = 127, fps: int = 6, augmentation_level: float = 0.0):
