...
class ImageBatchFilterInputs(InputSlots):
    ...
    def __init__(self, node: "Node"):
        ...
        self.replacement_image = Slot[Image](node, "replacement_image", 'IMAGE')
...
class ImageBatchFilter(Node[ImageBatchFilterInputs, ImageBatchFilterOutputs]):
    ...
    def __init__(self, images: Union[Slot[Image], Image], empty_color: str = '0, 0, 0', empty_threshold: float = 0.01, replacement_image: Optional[Union[Slot[Image], Image]] = None):
        super().__init__(**{"images": images, "empty_color": empty_color, "empty_threshold": empty_threshold, "replacement_image": replacement_image})
