...
class LoadAndResizeImageInputs(InputSlots):
    ...
    mask_channel: Slot[Union[Literal['alpha', 'red', 'green', 'blue'], str]]
    ...
    def __init__(self, node: "Node"):
        ...
        self.mask_channel = Slot[Union[Literal['alpha', 'red', 'green', 'blue'], str]](node, "mask_channel", ['alpha', 'red', 'green', 'blue'])
...
class LoadAndResizeImage(Node[LoadAndResizeImageInputs, LoadAndResizeImageOutputs]):
    ...
    Inputs:
        ...
        - mask_channel (Union[Literal['alpha', 'red', 'green', 'blue', str)
    ...
    def __init__(self, image: Union[Literal['beach.png', 'example.png', 'girl.png', 'sleeping.png'], str], mask_channel: Union[Literal['alpha', 'red', 'green', 'blue'], str], resize: bool = False, width: int = 512, height: int = 512, repeat: int = 1, keep_proportion: bool = False, divisible_by: int = 2, background_color: str = ''):
